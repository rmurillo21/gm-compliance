...
* {operating-officer-full-name}, COO: operating.office@domain.com
* {engineer-full-name}, Head of Engineering: engineer.email@domain.com
* {ceo-full-name}, CEO: ceo@domain.com
