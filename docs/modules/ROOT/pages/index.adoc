...
persons whose work performance is under the direct control of {company-short-name}, whether or not they are paid by {company-short-name}.
...
or business associates) are intended to be created by this Plan. {company-short-name} reserves the right to amend or change
